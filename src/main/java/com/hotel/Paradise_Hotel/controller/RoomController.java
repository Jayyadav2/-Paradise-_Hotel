...
import com.hotel.Paradise_Hotel.exception.PhotoRetrievalException;
...
public class RoomController {
   ...
   @PreAuthorize("hasRole('ROLE_ADMIN')")
    ...
    public List<String> getRoomTypes(){
        ...
        return  roomService.getAllRoomTypess();
    }
@GetMapping("/all-rooms")
   ...
   @PreAuthorize("hasRole('ROLE_ADMIN')")
    public  ResponseEntity<RoomResponse> updateRoom(@PathVariable Long roomId,
         ...
         Blob phtotBlod=photoBytes != null && photoBytes.length>0 ? new SerialBlob(photoBytes) : null;
         Room theRoom= roomService.updateRoom(roomId, roomType, roomPrice, photoBytes);
         theRoom.setPhoto(phtotBlod);
...
//                new BookingResponse(booking.getBookingId(),booking.getCheckInDate(), booking.getCheckOutDate(), booking.getBookingConfirmationCode() )).toList();
        ...
        if(photoBlob!=null){
            try{
                ...
                throw new PhotoRetrievalException("Error retriveving photo");
            }
        }
